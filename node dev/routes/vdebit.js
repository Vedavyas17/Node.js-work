...
router.post("/vendor/vdebit",async(req,res)=> {
    const vendorid = req.body.vendorid;
    console.log(vendorid);
    const Request_URL = 'http://SOLMAN.kaartech.com:8000/sap/bc/srt/rfc/sap/zws_vendor_debit1/100/zws_vendor_debit1/zws_vendor_debit1'
...
debiting= await fetch(Request_URL,
    ...
    parser.parseString(debiting, (err, data) => {
        if(err)
        {
            ...
            console.log(data)
            debit = data['soap-env:Envelope']['soap-env:Body'][0]['n0:ZBAPI_VENDOR_DEBIT_VEDResponse'][0]['IT_FINAL'][0]
            console.log(debit)
